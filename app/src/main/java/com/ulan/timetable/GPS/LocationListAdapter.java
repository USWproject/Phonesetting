...
public class LocationListAdapter extends RecyclerView.Adapter<LocationListAdapter.LocationListViewHolder> {
    ...
    private ArrayList<com.ulan.timetable.GPS.AutoSilenceLocation> locations;

    private RecyclerViewClickCallbacks recyclerViewClickCallbacks = null;

    LocationListAdapter(ArrayList<com.ulan.timetable.GPS.AutoSilenceLocation> locations) {
        this.locations = locations;
    }

    void setLocations(ArrayList<com.ulan.timetable.GPS.AutoSilenceLocation> locations) {
        this.locations = locations;
    ...
    public LocationListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.gps_location_list_item, parent, false);
    ...
    public interface RecyclerViewClickCallbacks {
